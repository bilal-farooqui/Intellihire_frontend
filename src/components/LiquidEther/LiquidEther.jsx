...
`
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: localDt, isBounce: localBounce, BFECC: localBFECC }) {
        this.uniforms.dt.value = localDt
        this.line.visible = localBounce
        this.uniforms.isBFECC.value = localBFECC
        super.update()
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous: localViscous, iterations, dt: localDt }) {
        let fbo_in, fbo_out
        this.uniforms.v.value = localViscous
